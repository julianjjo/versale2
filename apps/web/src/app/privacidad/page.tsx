  ...
  return (
    <section>
      ...
      <p className="mt-2 text-sm leading-relaxed text-text-muted">
        ...
        pasará a mostrarse como «Usuario eliminado», retiraremos tus datos personales —correo,
        nombre, contraseñas, direcciones de envío conservadas— y retiraremos del catálogo tus
        publicaciones activas. Tus pedidos se conservan únicamente como registro contable de la
        compra y las reseñas ya publicadas quedan a nombre de «Usuario eliminado».
      </p>
      {CONTACT_EMAIL ? (
        <p className="mt-2 text-sm leading-relaxed text-text-muted">
