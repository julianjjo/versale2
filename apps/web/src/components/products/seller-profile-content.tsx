...
export function SellerProfileContent({
   ...
   *  listing, this data has no auth-dependent branching (getSellerProfile
   *  takes no requester), so the anonymous server probe is just as valid for
   *  every visitor — no need to treat it as stale for a logged-in one. */
  initialProfile,
}: {
